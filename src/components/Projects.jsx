  ...
  return (
    <>
      <style>{`
        ...
        .modal-desc h2 { color: var(--text); font-size: 1.1rem; margin: 16px 0 8px; }
        .modal-desc h3 { color: var(--cyan); font-size: 0.95rem; margin: 12px 0 6px; }
        .modal-desc ul { padding-left: 20px; margin: 8px 0; }
        .modal-desc li { margin-bottom: 4px; color: var(--muted); font-size: 0.9rem; }
        ...
        <div className="modal-overlay" onClick={handleOverlayClick}>
          <div className="modal-box">
            ...
            <div className="modal-body">
              ...
              <ReactMarkdown>{modal.desc}</ReactMarkdown>
